<template>
  <div class="container">
    ...
    <h3>Overview</h3>
    <p>
      This website is operated by Mark Perez Digital LLC. Throughout the site,
      the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer
      to Mark Perez Digital LLC. Mark Perez Digital LLC offers this website,
    ...
    <p>
      ...
      our &ldquo;Service&rdquo; and agree to be bound by the following terms and
      conditions (&ldquo;Terms of Service&rdquo;, &ldquo;Terms&rdquo;),
    ...
    <p>
      Any new features or tools which are added to the current site shall also
    ...
    <h3>Section 1 &ndash; Website Terms</h3>
    <p>
    ...
    <p>
      You may not use our tools, content, or services for any illegal or
    ...
    <h3>
      Section 3 &ndash; Accuracy, Completeness And Timeliness Of Information
    </h3>
    <p>
    ...
    <p>Prices for our offerings are subject to change without notice.</p>
    <p>
    ...
    <h3>Section 5 &ndash; Offerings (if applicable)</h3>
    <p>
      Certain offerings may be available exclusively online through the website.
      These offerings may have limited quantities.
    </p>
    <p>
      We reserve the right, but are not obligated, to limit the sales of our
      offerings to any person, geographic region or jurisdiction. We may
      exercise this right on a case-by-case basis. We reserve the right to limit
      the quantities of any offerings. All descriptions of offerings or pricing
      are subject to change at anytime without notice, at the sole discretion of
      us. We reserve the right to discontinue any offering at any time. Any
      offering on this site is void where prohibited.
    </p>
    <p>
      We do not warrant that the quality of any offering, information, or other
    ...
    <p>
      ...
      sole discretion, limit or cancel purchases. These restrictions may include
    ...
    <p>
      ...
      information for all purchases made. You agree to promptly update your
    ...
    <p>
      Certain content and offers available via our Service may include materials
      from third-parties.
    </p>
    <p>
    ...
    <p>
      ...
      third-party&rsquo;s policies and practices and make sure you understand
    ...
    <p>
      ...
      &lsquo;comments&rsquo;), you agree that we may, at any time, without
    ...
    <p>
      ...
      violates any party&rsquo;s intellectual property or these Terms of
      Service.
    </p>
    <p>
    ...
    <p>
      ...
      our Privacy Policy. To view our&nbsp;<n-link to="/privacy/"
    ...
    <p>
      ...
      to descriptions, pricing, promotions, offers, product charges, and
    ...
    <h3>
      Section 13 &ndash; Disclaimer Of Warranties; Limitation Of Liability
    </h3>
    <p>
    ...
    <p>
      ...
      &lsquo;as is&rsquo; and &lsquo;as available&rsquo; for your use, without
    ...
    <p>
      In no case shall Mark Perez Digital LLC, our directors, officers,
    ...
    <p>
      You agree to indemnify, defend and hold harmless Mark Perez Digital LLC
      ...
      including reasonable attorneys&rsquo; fees, made by any third-party due to
      or arising out of your breach of these Terms of Service or the documents
      they incorporate by reference, or your violation of any law or the rights
      of a third-party.
    </p>
    ...
    <p>
      ...
      North Dakota, Cass County, Fargo, USA.
    </p>
    ...
    <p>
      ...
      our&nbsp;<n-link to="/contact/">contact page</n-link>.
    </p>
  </div>
</template>
