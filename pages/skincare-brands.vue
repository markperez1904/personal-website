<template>
  <div class="outer">
              ...
              <div class="max-w-md">
                ...
                <div class="mb-6 max-w-sm">
                  <p class="text-gray-500 leading-loose">
                    Learn how you can boost your skincare business with
                ...
                <div class="flex flex-wrap lg:-ml-5">
                  ...
                  >
                    <n-link to="/book/" style="color: #ffffff">Show Me How</n-link>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="flex flex-wrap -mx-6">
            <div class="mb-6 w-full lg:w-1/2 px-6">
              <h2 class="mb-6 text-2xl font-bold">
                We Get Your Skincare Brand Recognized
              </h2>
              <p class="text-gray-500 leading-loose">
            ...
            <div class="w-full lg:w-1/2 px-6 h-80">
              <img
    ...
    <!-- 3rd section -->
    <section>
      <div class="skew skew-top mr-for-radius"></div>
      <div class="py-20 bg-gray-50 radius-for-skewed">
        <div class="container mx-auto px-4">
          <div class="mb-16 max-w-md mx-auto text-center">
            ...
            <h2 class="text-4xl md:text-5xl font-bold">
              How We Help Your Skincare Brand
            </h2>
          </div>
          <div class="flex flex-wrap -mx-4">
            <div class="mb-12 lg:mb-0 w-full md:w-1/2 lg:w-1/4 px-4">
              <span
                class="mb-4 md:mb-6 inline-block bg-green-100 p-3 text-green-500 rounded"
              >
                <svg
                  class="w-8 h-8"
      ...
      <div class="container mx-auto px-4">
        <div class="max-w-2xl mx-auto">
          <div class="flex flex-wrap -mx-6">
            ...
            <div class="mb-6 w-full lg:w-1/2 px-6">
              <h2 class="mb-6 text-2xl font-bold">
                Custom Marketing Solutions for You
              </h2>
              <p class="text-gray-500 leading-loose">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Praesent commodo est eget consequat imperdiet. Suspendisse
