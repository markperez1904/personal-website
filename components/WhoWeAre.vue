<template>
  <div class="whoweare container">
    <div class="whoweare-background">
      <div class="item1"></div>
      <div class="item2"></div>
      <div class="item3"></div>
    </div>
    <div class="whoweare-top v-scroll-reveal" v-scroll-reveal.reset="{ delay: 250 }">
    ...
    <div class="whoweare-items">
      ...
      <div class="whoweare-center v-scroll-reveal" v-scroll-reveal.reset="{ delay: 250 }">
        <div class="whoweare-item">
          <div class="whoweare-item-img">
            <img src="~/assets/svg/star.svg" alt="star" />
          </div>
      ...
      <div class="whoweare-right v-scroll-reveal" v-scroll-reveal.reset="{ delay: 250 }">
        <div class="whoweare-item">
          <div class="whoweare-item-img">
            <img src="~/assets/svg/star.svg" alt="star" />
          </div>
    ...
    <div class="whoweare-bottom">
      ...
      <div class="whoweare-bottom-right">
        <button class="whoweare-bottom-button">Request Proposal</button>
      </div>
    </div>
  </div>
</template>
...
.whoweare-top .whoweare-top-title {
  font-size: 34px;
  line-height: 41px;
  color: #2f495e;
  font-weight: bold;
...
.whoweare-item {
  ...
  margin: 20px 0;
  border-radius: 15px;
  filter: drop-shadow(0 0 23px rgba(0, 185, 134, 0.12));
...
.whoweare-item-img img {
  width: 20px;
  height: 20px;
}

.whoweare-background .item1 {
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
...
.whoweare-bottom {
  ...
  height: 217px;
  border-radius: 10px;
  background-image: linear-gradient(0deg, #00c58e 0%, #00f0ad 100%);
}
...
.whoweare-bottom .whoweare-bottom-button {
  width: 198px;
  height: 52px;
  border-radius: 26px;
  background-color: #2f495e;
